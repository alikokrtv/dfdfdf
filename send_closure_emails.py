...
# -*- coding: utf-8 -*-
"""
Kapatılan DÖF'ler için Tek Seferlik E-posta Gönderimi
...
def send_closure_notifications():
    ...
    print("🚀 Kapatılan DÖF'ler için e-posta gönderimi başlıyor...")
    print("=" * 60)
        ...
        for stakeholder in stakeholders:
            ...
            <body>
                <div class="container">
                    ...
                    <p>
                        <a href="http://localhost:5000/dof/{dof_id}" class="button">DÖF Detaylarını Görüntüle</a>
                    </p>
            ...
            DÖF detaylarını görüntülemek için: http://localhost:5000/dof/{dof_id}
